    ...
    <div id="misc">
      <TooltipWrapper isHidden={props.help}>
        ...
        <h5>
          ...
          : <strong>Left Click:</strong> Displays up to the last 10 cell value
          history changes/time.
        </h5>
        <h5>
          <u>
            <strong>Cell Contents Update Notification</strong>
          </u>
          : A red border box will be placed around the cell if recently
          updated/refreshed.
        </h5>
        <h5>
          <u>
  ...
  return (
    <TooltipWrapper id="ipad-help-div">
      ...
      <h6>
        ...
        <strong>Left Action</strong>: Displays up to the last 10 cell value
        history changes/time.
      </h6>
      <h6>
        <u>
